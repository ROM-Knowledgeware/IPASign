...
{
    public class AndExpression : RequirementExpression
    {
        public RequirementExpression Expression1;
        public RequirementExpression Expression2;

        public AndExpression(RequirementExpression expression1, RequirementExpression expression2)
        {
            Expression1 = expression1;
            Expression2 = expression2;
        }

        public AndExpression(byte[] buffer, ref int offset)
        {
        ...
        {
            BigEndianWriter.WriteUInt32(buffer, ref offset, (uint)RequirementOperatorName.And);
